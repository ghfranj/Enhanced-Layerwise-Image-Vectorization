    ...
    def build_extension(self, ext):
        if isinstance(ext, CMakeExtension):
            ...
            cmake_args = ['-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=' + extdir,
                       #   '-DPYTHON_LIBRARY=' + 'C:\\ProgramData\\anaconda3\\envs\\live',
            ...
            print("hello123 ", build_args, self.build_temp)
            source_path = 'python310.lib'
            destination_path = self.build_temp + '/python310.lib'
